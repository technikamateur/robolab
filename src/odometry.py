...
def playSound_zeldaSecret():
	Sound.tone([(783.99,150,0),(739.99,150,0),(622.25,150,0),(440,150,0),(415.3,150,0),(659.25,150,0),(830.61,150,0),(1046.5,150,0)])

def playSound_telekom():
	Sound.tone([(783.99,225,10),(783.99,225,10),(783.99,225,10),(987.77,225,10),(783.99,225,10)])
	...
	def drive(self, bs = 100, kp = 1, ki = 0, kd = 0, gray = 250):	#main driving method
		...
		while True:						#Feedback-Loop
			...
			if colorsum <= 650:			#Bob is near the white/black line
				...
				Sound.tone([(3135.96,100,150),(3135.96,100,150),(3729.31,75,75),(3135.96,100,75)])
		...
		time.sleep(0.45)					#get wheels to the right position
		self.mr.stop()
		self.ml.stop()
